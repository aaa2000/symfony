    ...
    public function describe(OutputInterface $output, $object, array $options = array())
    {
        ...
        switch (true) {
            ...
            case $object instanceof ParameterBag:
                ...
                break;
            case $object instanceof ContainerBuilder && isset($options['group_by']) && 'tags' === $options['group_by'] && isset($options['autoconfigure']) && true === $options['autoconfigure']:
